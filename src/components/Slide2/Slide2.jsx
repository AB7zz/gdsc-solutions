...
const Slide2 = () => {
  ...
  const events = [
    {
      title: 'SOLUTION',
      desc: "To alleviate water scarcity in arid lands, ie, in India for example, Thar desert, regions of Rajasthan, Punjab,  Gujurat, Haryana - we bring forth a novel innovation in water harvesting mechanism from desert air. The solution is a dome-like structure which consists of 3 unique layers: A ridged outer layer (ROL) Hydrophilic condensation layer (HCL) Peltier-cooled condensation layer (PCCL) The ridged (bumpy) outer layer follows in the principle of Bernoullis effect, effectively exposing more surface area to the desert breeze. Beneath it, a hydrophilic condensation layer consisting of hydrogel-like material absorbs the water and streams it into a water collection basin below. The innermost layer is a Peltier cooler, powered by solar energy, which offers thermoelectric cooling for dew condensation.",
      eventNo: 1
    },
    {
      title: 'WHAT WE OPTIMIZE',
      desc: "Water harvesting capabilities of exisitng inventions - introduced a low-cost cooling mechanism Water holding capacities of existing inventions - cheap production material with high absorbent properties", eventNo: 2
    },
    {
    ...
    <div ref={componentRef} id="events" className={`component md:mt-20 md:h-[100%] md:min-h-screen relative z-30 max-w-full overflow-hidden`}>
      <div className='grid md:grid-cols-5 grid-cols-1'>
        <div className={`${animate && !isMobile ? 'fade' : 'md:hidden' } md:fixed top-0 z-20 col-span-1 h-[100%] bg-black md:px-40 py-10 bg-vector`}>
          <h1 className={`${animate ? 'fade' : 'hidden' } text-white roboto flex justify-center md:flex-col items-center md:mt-[20vh]`}>
            ...
            <div className='grid md:grid-cols-5 md:mt-[0vh] grid-cols-1'>
              <div>
                ...
                <div className={`col-span-1 hover:cursor-pointer eventBox${events[chosenEvent].eventNo} flex items-center bg-black h-[350px] w-[200px]`}>
                  <h1 className='text-white text-4xl -rotate-90 roboto'>{events[chosenEvent].title}</h1>
                </div>
              </div>
        ...
        {!details && <div className='md:ml-[420px] bg-black w-screen h-[100%]'>
          <div className='hidden md:flex max-w-full overflow-x-auto overflow-y-hidden md:flex-wrap'>
            <div onClick={() => {
              ...
              <h1 className='text-white text-3xl -rotate-90 roboto'>SOLUTION</h1>
            </div>
            <div className='bg-black border-l-[0.3px] border-r-[0.3px] border-[#4d4d4d] h-[250px] w-[150px]'>
              <h1 className='text-black text-6xl -rotate-90 roboto'>1940</h1>
            </div>
            <div className='bg-black border-l-[0.3px] border-r-[0.3px] border-[#4d4d4d] h-[250px] w-[150px]'>
              <h1 className='text-black text-6xl -rotate-90 roboto'>1940</h1>
            </div>
            ...
            <div onClick={() => {
              ...
              <h1 className='text-white text-3xl -rotate-90 roboto'>WHAT WE OPTIMIZE</h1>
            </div>
            <div className='bg-black border-l-[0.3px] border-r-[0.3px] border-[#4d4d4d] h-[250px] w-[150px]'>
              <h1 className='text-black text-6xl -rotate-90 roboto'>1940</h1>
            </div>
          ...
          <div className='hidden md:flex max-w-full overflow-x-auto overflow-y-hidden md:flex-wrap'>
            ...
            <div onClick={() => {
              ...
              <h1 className='text-white text-3xl -rotate-90 roboto'>CANSAT WORKSHOP</h1>
            </div>
            <div className='bg-black border-l-[0.3px] border-r-[0.3px] border-[#4d4d4d] h-[250px] w-[150px]'>
              <h1 className='text-black text-6xl -rotate-90 roboto'>1940</h1>
            </div>
            <div onClick={() => {
              ...
              <h1 className='text-white text-3xl -rotate-90 roboto'>POPSICLE BRIDGE CHALLENGE</h1>
            </div>
            <div className='bg-black border-l-[0.3px] border-r-[0.3px] border-[#4d4d4d] h-[250px] w-[150px]'>
              <h1 className='text-black text-6xl -rotate-90 roboto'>1940</h1>
            </div>
            <div onClick={() => {
              ...
              <h1 className='text-white text-3xl -rotate-90 roboto'>HORIZON</h1>
            </div>
            <div className='bg-black border-l-[0.3px] border-r-[0.3px] border-[#4d4d4d] h-[250px] w-[150px]'>
              <h1 className='text-black text-6xl -rotate-90 roboto'>1940</h1>
            </div>
          ...
          <div className='hidden md:flex max-w-full overflow-x-auto overflow-y-hidden md:flex-wrap'>
            ...
            <div onClick={() => {
              ...
              <h1 className='text-white text-3xl -rotate-90 roboto'>ASTROCHACK</h1>
            </div>
            <div className='bg-black border-l-[0.3px] border-r-[0.3px] border-[#4d4d4d] h-[250px] w-[150px]'>
              <h1 className='text-black text-6xl -rotate-90 roboto'>1940</h1>
            </div>
          ...
          <div className='flex md:hidden max-w-full overflow-x-auto overflow-y-hidden md:flex-wrap'>
            <div onClick={() => {
              ...
              <h1 className='text-white text-3xl -rotate-90 roboto'>SPACE ON WHEELS</h1>
            </div>
            <div onClick={() => {
              setDetails(true)
              setChosenEvent(1)
