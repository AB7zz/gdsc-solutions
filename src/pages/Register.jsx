            ...
            <div className='flex md:flex-row flex-col'>
                {!next && <div className='bg-white px-5 py-10 md:w-[30%] w-screen'>
                    ...
                    <div className='my-10 grid'>
                        ...
                        <div className='flex'>
                            <button onClick={() => setFormData({ ...formData, isFromCUSAT: 'YES' })} className={`px-7 py-3 text-black border-[1.5px] border-black ml-3 hover:text-white hover:bg-[#41980a] hover:border-none focus:text-white focus:bg-[#41980a] focus:border-none ${formData.isFromCUSAT == 'YES' && 'bg-[#41980a] text-white border-none'}`}>YES</button>
                            <button onClick={() => setFormData({ ...formData, isFromCUSAT: 'NO' })} className={`px-7 py-3 text-black border-[1.5px] border-black ml-3 hover:text-white hover:bg-[#41980a] hover:border-none focus:text-white focus:bg-[#41980a] focus:border-none ${formData.isFromCUSAT == 'NO' && 'bg-[#41980a] text-white border-none'}`}>NO</button>
                        </div>
                        
                        <label htmlFor="" className='text-black text-left mr-3'>Are you SEDS member?</label>
                        <div className='flex'>
                            <button onClick={() => setFormData({ ...formData, isSEDSMember: 'YES' })} className={`px-7 py-3 text-black border-[1.5px] border-black ml-3 hover:text-white hover:bg-[#41980a] hover:border-none focus:text-white focus:bg-[#41980a] focus:border-none ${formData.isSEDSMember == 'YES' && 'bg-[#41980a] text-white border-none'}`}>YES</button>
                            <button onClick={() => setFormData({ ...formData, isSEDSMember: 'NO' })} className={`px-7 py-3 text-black border-[1.5px] border-black ml-3 hover:text-white hover:bg-[#41980a] hover:border-none focus:text-white focus:bg-[#41980a] focus:border-none ${formData.isSEDSMember == 'NO' && 'bg-[#41980a] text-white border-none'}`}>NO</button>
                        </div>
                        ...
                        <button onClick={handleNext} className='px-10 py-3 text-white bg-[#41980a] text-center'>NEXT</button>
                        {error && <p className='text-green-500 text-xl my-5 font-bold text-center'>{error}</p>}
                ...
                <div className='md:ml-20 bg-white px-5 py-10 h-full'>
                    ...
                    <div className='flex my-5'>
                        ...
                        <button onClick={handleSubmit} className='px-7 py-3 border-[1.5px] border-black bg-[#41980a] text-white border-none'>Submit</button>
                        {error && <p className='text-green-500 text-xl my-5 font-bold text-center'>{error}</p>}
                    </div>
                </div>}
            </div>    
